...
class TestPQCryptoMLDSA87 < Minitest::Test
  def test_generate_sign_verify
    keypair = PQCrypto::Signature.generate(:ml_dsa_87)
    signature = keypair.secret_key.sign("message")

    assert_equal :ml_dsa_87, keypair.algorithm
    assert_equal PQCrypto::SIGN_87_PUBLIC_KEY_BYTES, keypair.public_key.to_bytes.bytesize
    assert_equal PQCrypto::SIGN_87_SECRET_KEY_BYTES, keypair.secret_key.to_bytes.bytesize
    assert_equal PQCrypto::SIGN_87_BYTES, signature.bytesize
